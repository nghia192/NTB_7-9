...
-- ================================================================
-- Update SP_SYS_LanguageResource to respect resource ordering (SYS_ResourceOrder)
-- and to continue to support existing actions. This drop/recreate keeps
-- behavior identical except ordering in GET_ALL / SEARCH / GET_BY_LANG / GET_BY_MODULE
-- will prefer ResourceSortOrder when present.
-- ================================================================
